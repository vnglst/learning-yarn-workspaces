...
var vnglstGamma = _interopDefault(require('vnglst-gamma'));
var vnglstDelta = _interopDefault(require('vnglst-delta'));
...
isValidElement:O,version:"16.6.0",__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:{ReactCurrentOwner:K,assign:objectAssign}},Y={default:X},Z=Y&&X||Y;var react_production_min=Z.default||Z;
...
console.log(vnglstGamma + ' ' + vnglstDelta + ' ' + React.version);
